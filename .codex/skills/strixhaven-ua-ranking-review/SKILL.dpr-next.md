...
- Follow the official skill's SRD 5.2.1 conversion audit when mapping 5e-era UA wording onto 2024 base classes. In particular, re-check Magic / Attack / Study / Influence / Utilize action names, Heroic Inspiration, spell preparation, always-prepared spells, Weapon Mastery, Fighting Style feats, and class-specific subclass feature slots before scoring.
