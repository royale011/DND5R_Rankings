...
When comparing a homebrew feature to a verified official / UA / partner / third-party reference, account for both sides of the exchange before judging it too strong, too weak, acceptable, or unclear. State the homebrew's major gains over the reference, and also its real costs, limits, regulators, timing restrictions, resource pressure, target/scope limits, counterplay, chassis constraints, or table-operation burden. This does not require a formal comparison table; include the accounting naturally in `详细评价`, `横向对照与不确定点`, `修改建议`, or the relevant scoring reason.
