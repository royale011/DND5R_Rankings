...
- Resource counting, action economy, concentration, melee / short-range / multi-hit damage-increment resources, unwanted interruption, severe costs, and feature-overlap analysis: official `Build the actual rules context before scoring`.
