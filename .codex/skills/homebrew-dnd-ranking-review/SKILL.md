...
- Design-score separation, design-expression drift checks, latest-online-lore verification for setting-bound concepts, shared 2024 assumptions, and blunt Simplified Chinese output style: official `Apply design-score separation`, `Account for shared 2024 assumptions`, and `Output Style`.
